...
const ArraySearchingDesign = () => {
  return (
    <LinearGradient 
        colors={[ '#3a435e', '#001c55',]} 
        start = {{x:0.9, y:1}}
        end= {{x:0.3, y:0.1}}
        style={styles.mainHeader}>
        <Text style={styles.TextHeader}>Searching</Text>
        <View>
            <Text style={[styles.TextHeader, {fontSize:RFValue(16), color:'#dedede',}]}>Linear Search</Text>
        ...
        <Text style={styles.sampleText}>To Perform the Linear Search the Array can be in any state (sorted/unsorted)</Text>


        <View>
            <Text style={[styles.TextHeader, {fontSize:RFValue(16), color:'#dedede',marginTop:height*0.02}]}>Binary Search</Text>
            <View style={styles.ArrayStyle}>
                <View style={styles.view11}>
                    <Text style={{fontSize:RFValue(13), fontWeight:'700'}}>0</Text>
                </View>
                <View style={styles.view1}>
            ...
            <Text style={styles.sampleText}>To Perform the Binay Search the Array should be in sorted state.</Text>
        </View>
...
export default ArraySearchingDesign